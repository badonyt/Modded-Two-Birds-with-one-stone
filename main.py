...
def main():
    ...
    elif memesounds == True:
        bonkfx = pygame.mixer.Sound("data/sfx/meme/yousuck.wav")
        launchfx = pygame.mixer.Sound("data/sfx/launch.wav")
        killfx = pygame.mixer.Sound("data/sfx/meme/kill.wav")
        losefx = pygame.mixer.Sound("data/sfx/meme/lose.wav")
        winfx = pygame.mixer.Sound("data/sfx/meme/claps.wav")
    ...
    while splashScreenTimer < 2:
        ...
        startMessage = font_28.render("Modded BY Bad", True, (48, 40, 120))
        display.blit(startMessage, (display.get_width()/2 - startMessage.get_width()/2, display.get_height()/2 - startMessage.get_height()/2 + 30))
    ...
    while running:
        ...
        if not (currentLevel > 9):
            ...
            if shotss == True:
                ...
                shotsText = font_28.render('Died: ' + str(diesss).zfill(3), True, (0, 0, 0))
